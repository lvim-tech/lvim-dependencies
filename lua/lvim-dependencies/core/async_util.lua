...
-- (all_with_limit/all_settled) and the debounce/throttle helpers all sit on the same
-- safe_resume core, which reschedules any coroutine error onto the main loop
